            ...
            <section className="py-16 px-4 bg-accent/50">
              <div className="container mx-auto max-w-4xl text-center">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  На сервере доступны вертолёты для быстрого перемещения, а также уникальные предметы: майнинг-фермы для заработка ресурсов, 
                  игровые автоматы для развлечений и многое другое!
                </p>
              </div>
            </section>
              ...
              <div className="container mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="relative overflow-hidden rounded-lg group">
                    <img 
                      src="https://cdn.poehali.dev/projects/1a12b4df-8a86-4057-92b8-96719167ab3f/files/74b81e42-3744-49bf-acf9-2bfa6e559391.jpg" 
